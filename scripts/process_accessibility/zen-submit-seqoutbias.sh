...
# these scripts are written by write_slurm_scripts.sh
./ENCFF059BEU_h1hesc.bam_process.sh  
./ENCFF591XCX_hpeg2.bam_process.sh    
./ENCFF966NIW_gm12878.bam_process.sh
./ENCFF538GKX_K562.bam_process.sh    
